<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AthleticsSecondary.ascx.cs" Inherits="DotNetNuke.UI.Skins.Skin" %>
...
<div class="base">
    ...
    <main>
        <div id="CarouselPane" class="carousel-pane cp-secondary"></div>
        ...
        <div class="container-fluid">
            ...
            <div class="title-banner row">
                <div class="title-banner-grey-back"></div>
                <div class="container">
                    <div class="col-sm-4 col-xs-3 title-banner-icon"><img class="sport-icon" src="http://wwwtest.parkland.edu/Portals/0/images/sport-icons/volleyball.png" /></div>
                    <div class="col-sm-8 col-xs-9 title-banner-text">
                        WOMEN'S<br />VOLLEYBALL
                    </div>
                </div>
            </div>

            <div class="secondary-nav row">
                <div class="col-sm-4 secondary-nav-item"><a href="#">SCHEDULE</a></div>
                <div class="col-sm-4 secondary-nav-item"><a href="#">ROSTER/COACHES</a></div>
                <div class="col-sm-4 secondary-nav-item"><a href="#">ALUMNI/RECORDS</a></div>
                <div class="col-sm-4 secondary-nav-item"><a href="#">COACHING STAFF</a></div>
                <div class="col-sm-4 secondary-nav-item"><a href="#">RECRUITING</a></div>
                <div class="col-sm-4 secondary-nav-item"><a href="#">SUMMER CAMPS</a></div>
            </div>

            <div class="main-content-row row">
                <div class="container">
                    <div id="mainContent" class="col-sm-12" runat="server"></div>
                </div>
            </div>
