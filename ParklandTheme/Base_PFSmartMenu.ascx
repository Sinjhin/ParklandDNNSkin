...
<%@ Register TagPrefix="PF" TagName="NAV" Src="~/DesktopModules/PfDnnNavigation/SkinObject.ascx" %>
...
<div class="base">
    ...
    <nav id="mainNav" class="main-nav" role="navigation">
        <ul class="large-menu hidden-xs">
            <PF:NAV ID="dnnMenu" runat="server" AdminMenuDisplaySetting="SuppressAdminMenu" DataSource="SmartMenu" UseDynamicSettings="true" DisplayFormat="MegaDropDownComplex" ContentType="MegaDropDown" MenuClass="MenuWrapperMega" UseOrdinalID="true" />
        </ul>
        ...
        <ul class="xs-menu visible-xs-inline-block">
            <PF:NAV ID="dnnMenu02" runat="server" AdminMenuDisplaySetting="SuppressAdminMenu" DataSource="SmartMenu" UseDynamicSettings="true" DisplayFormat="MegaDropDownComplex" ContentType="MegaDropDown" MenuClass="MenuWrapperMega" UseOrdinalID="true" />
        </ul>
    </nav>
    <main>
